...
async function init()
{
    const modelURL = "myPoseModel/model.json";
    const metadataURL = "myPoseModel/metadata.json";
...
{
    unityInstance.SendMessage("CharacterForLunge", "getKey", value);
    unityInstance.SendMessage("CharacterForSquat", "getKey", value);
}